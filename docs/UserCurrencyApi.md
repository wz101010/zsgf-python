...
with ZSGF.Client.ApiClient(configuration) as api_client:
    ...
    app_key = 'app_key_example' # str | 
    currency_consume_request = ZSGF.Client.CurrencyConsumeRequest() # CurrencyConsumeRequest |  (optional)
...
with ZSGF.Client.ApiClient(configuration) as api_client:
    ...
    signature = 'signature_example' # str | 签名
    app_key = 'app_key_example' # str | 
    exchange_currency_request = ZSGF.Client.ExchangeCurrencyRequest() # ExchangeCurrencyRequest |  (optional)
...
with ZSGF.Client.ApiClient(configuration) as api_client:
    ...
    signature = 'signature_example' # str | 签名
    app_key = 'app_key_example' # str | 
    recharge_point_request = ZSGF.Client.RechargePointRequest() # RechargePointRequest |  (optional)
