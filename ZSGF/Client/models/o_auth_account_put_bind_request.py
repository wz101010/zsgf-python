...
class OAuthAccountPutBindRequest(BaseModel):
    """
    OAuthAccountPutBindRequest
    """ # noqa: E501
    avatar: Optional[StrictStr] = Field(default=None, description="头像")
    data: Optional[StrictStr] = Field(default=None, description="自定义数据")
    enable: Optional[StrictBool] = Field(default=None, description="启用")
    __properties: ClassVar[List[str]] = ["avatar", "data", "enable"]
