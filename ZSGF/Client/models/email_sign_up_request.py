...
class EmailSignUpRequest(BaseModel):
    ...
    EmailSignUpRequest
    """ # noqa: E501
    email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="用户邮箱地址")
    pwd: Annotated[str, Field(min_length=6, strict=True, max_length=32)] = Field(description="用户密码，长度为6到32个字符")
    email_code: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="邮箱验证码", alias="emailCode")
    phone: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="手机号，必须为11位数字")
