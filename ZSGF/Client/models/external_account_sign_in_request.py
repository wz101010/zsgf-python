...
class ExternalAccountSignInRequest(BaseModel):
    """
    ...
    platform: Annotated[str, Field(min_length=1, strict=True, max_length=20)] = Field(description="平台，长度必须在1到20个字符之间，只能包含字母和数字")
    ...
    __properties: ClassVar[List[str]] = ["unionID", "platform", "twoFactorCode"]
