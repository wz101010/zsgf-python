...
class SystemFileListResult(BaseModel):
    """
    SystemFileListResult
    """ # noqa: E501
    directories: Optional[List[SystemDirectoryItem]] = None
    files: Optional[List[SystemFileItem]] = None
    size: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["directories", "files", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "directories": [SystemDirectoryItem.from_dict(_item) for _item in obj["directories"]] if obj.get("directories") is not None else None,
            "files": [SystemFileItem.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None,
            "size": obj.get("size")
        })
        return _obj
