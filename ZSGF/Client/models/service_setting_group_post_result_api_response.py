...
class ServiceSettingGroupPostResultApiResponse(BaseModel):
    """
    ServiceSettingGroupPostResultApiResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=200, description="状态码")
    data: Optional[ServiceSettingGroupPostResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ServiceSettingGroupPostResult.from_dict(obj["data"]) if obj.get("data") is not None else None,
