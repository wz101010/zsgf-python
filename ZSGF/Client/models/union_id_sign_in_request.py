...
class UnionIDSignInRequest(BaseModel):
    """
    UnionIDSignInRequest
    """ # noqa: E501
    union_id: Annotated[str, Field(min_length=1, strict=True, max_length=99)] = Field(description="UnionID，长度必须在1到99个字符之间，只能包含字母、数字、下划线和连字符", alias="unionID")
