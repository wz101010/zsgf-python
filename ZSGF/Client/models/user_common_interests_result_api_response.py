...
class UserCommonInterestsResultApiResponse(BaseModel):
    """
    UserCommonInterestsResultApiResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=200, description="状态码")
    data: Optional[UserCommonInterestsResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": UserCommonInterestsResult.from_dict(obj["data"]) if obj.get("data") is not None else None,
