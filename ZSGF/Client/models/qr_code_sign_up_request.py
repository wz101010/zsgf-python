...
class QRCodeSignUpRequest(BaseModel):
    """
    QRCodeSignUpRequest
    """ # noqa: E501
    sign_in_key: Optional[StrictInt] = Field(default=None, description="登录密钥", alias="signInKey")
    union_id: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="UnionID，长度必须在1到50个字符之间，只能包含字母、数字、下划线和连字符", alias="unionID")
    ...
    __properties: ClassVar[List[str]] = ["signInKey", "unionID", "nickName", "avatar", "data", "email", "emailCode", "phone", "phoneCode"]
