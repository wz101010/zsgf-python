...
class QRCodeSignUpRequest(BaseModel):
    ...
    QRCodeSignUpRequest
    """ # noqa: E501
    sign_in_key: Optional[StrictInt] = Field(default=None, alias="signInKey")
    union_id: Annotated[str, Field(min_length=1, strict=True, max_length=99)] = Field(alias="unionID")
