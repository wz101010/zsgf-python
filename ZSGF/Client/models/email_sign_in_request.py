...
class EmailSignInRequest(BaseModel):
    ...
    two_factor_code: Optional[Annotated[str, Field(min_length=6, strict=True, max_length=6)]] = Field(default=None, description="双因素认证代码，如果启用双因素认证登录，则必填", alias="twoFactorCode")
    __properties: ClassVar[List[str]] = ["email", "verifyCode", "twoFactorCode"]
