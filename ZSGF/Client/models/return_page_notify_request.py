...
class ReturnPageNotifyRequest(BaseModel):
    ...
    auth_app_id: Optional[StrictStr] = None
    charset: Optional[StrictStr] = None
    method: Optional[StrictStr] = None
    out_trade_no: Optional[StrictStr] = None
    seller_id: Optional[StrictStr] = None
    sign: Optional[StrictStr] = None
    sign_type: Optional[StrictStr] = None
    timestamp: Optional[StrictStr] = None
    total_amount: Optional[StrictStr] = None
    trade_no: Optional[StrictStr] = None
