...
class SignInRequest(BaseModel):
    ...
    SignInRequest
    """ # noqa: E501
    user_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="userName")
    pwd: Annotated[str, Field(min_length=1, strict=True)]
    two_factor_code: Optional[StrictStr] = Field(default=None, description="如果启用双因素认证登录，则必填", alias="twoFactorCode")
    __properties: ClassVar[List[str]] = ["userName", "pwd", "twoFactorCode"]
