...
class UserSettingListApiResponse(BaseModel):
    """
    UserSettingListApiResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=200, description="状态码")
    data: Optional[List[UserSetting]] = Field(default=None, description="响应数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [UserSetting.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
