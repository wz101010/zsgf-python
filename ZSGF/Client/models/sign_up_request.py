...
class SignUpRequest(BaseModel):
    ...
    SignUpRequest
    """ # noqa: E501
    user_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="登录账号，4~18位", alias="userName")
    pwd: Annotated[str, Field(min_length=6, strict=True, max_length=32)] = Field(description="登录密码，6~32位")
