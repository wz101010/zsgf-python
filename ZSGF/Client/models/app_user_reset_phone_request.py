...
class AppUserResetPhoneRequest(BaseModel):
    """
    AppUserResetPhoneRequest
    """ # noqa: E501
    phone: Optional[StrictStr] = Field(default=None, description="手机号码")
    code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="手机验证码")
