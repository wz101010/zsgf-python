...
class CurrencyConsumeRequest(BaseModel):
    """
    CurrencyConsumeRequest
    """ # noqa: E501
    currency: Annotated[str, Field(min_length=1, strict=True)] = Field(description="虚拟币代码")
    balance: StrictInt = Field(description="消费额")
    ...
    __properties: ClassVar[List[str]] = ["currency", "balance", "remark", "description", "tags"]
