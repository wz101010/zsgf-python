...
class AccessTokenPostRequest(BaseModel):
    """
    ...
    expire_in_days: Optional[Annotated[int, Field(le=3650, strict=True, ge=-1)]] = Field(default=None, alias="expireInDays")
    __properties: ClassVar[List[str]] = ["title", "tags", "userID", "description", "permissions", "expireInDays"]
