...
class ServiceProviderListApiResponse(BaseModel):
    """
    ServiceProviderListApiResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=200, description="状态码")
    data: Optional[List[ServiceProvider]] = Field(default=None, description="响应数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ServiceProvider.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
