...
class OAuthAccountBindRequest(BaseModel):
    """
    ...
    platform_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="platformName")
    avatar: Optional[StrictStr] = None
    data: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["unionID", "platform", "platformName", "avatar", "data"]
