...
class GeoLocationResponseModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["locationName", "latitude", "longitude", "locationType", "recipientName", "phoneNumber", "email", "country", "state", "city", "district", "street", "zipCode", "address", "mapType", "remark", "tags", "enable", "showIndex", "createDate", "lastUpdate", "id"]
